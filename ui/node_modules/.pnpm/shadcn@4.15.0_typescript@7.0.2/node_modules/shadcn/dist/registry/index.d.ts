...
declare function resolveRegistryTree(names: z.infer<typeof registryItemSchema>["name"][], config: Config, options?: RegistryFetchOptions): Promise<{
    tailwind?: {
        config?: {
...
interface AddComponentsOptions {
    overwrite?: boolean;
...
interface AddRegistryItemsOptions extends Pick<AddComponentsOptions, "overwrite" | "overwriteCssVars" | "silent" | "skipFonts" | "path"> {
 ...
 */
declare function addRegistryItems(items: string[], options?: AddRegistryItemsOptions): Promise<void>;
